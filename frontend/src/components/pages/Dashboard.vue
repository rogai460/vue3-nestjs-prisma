...
<template>
  <div class="w-full md:px-0 md:mt-8 mb-16 text-gray-800 leading-normal">
    ...
    <ProjectDetailSummaryCard :sum-sales="totalSumSales" :sum-profit-rate="totalSumProfitRate" :ave-cost="totalAveCost" />
    <h1 class="px-4 py-3 text-3xl font-bold underline text-gray-600 dark:text-white">年間売上推移と売上割合</h1>
