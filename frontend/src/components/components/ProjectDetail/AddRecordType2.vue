...
<template>
  <div class="my-4">
    <h5 class="text-xl font-medium text-gray-900 dark:text-white">レコード追加（シミレーション用）</h5>
    <div
    ...
    >
      <form class="grid grid-cols-4 gap-4" action="#">
        <div>
          <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">名称</label>
          <input
        ...
        <div>
          <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">売単価（万円）</label>
          <input
        ...
        <div>
          <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">買単価（万円）</label>
          <input
